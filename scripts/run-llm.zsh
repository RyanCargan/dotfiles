...
case "$MODEL" in
  qwen|rwkv)  PORT=$FIM_PORT; CTX=8192; NGL=-1; CTK="f16"; CTT="f16" ;;
  mini)       PORT=$GEN_PORT; CTX=8192;  NGL=-1; CTK="f16"; CTT="f16" ;;
  asr)        PORT=$ASR_PORT; CTX=8192;  NGL=-1; CTK="f16"; CTT="f16" ;;
